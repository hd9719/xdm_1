...
public class HelpDialog extends JFrame implements ListSelectionListener,
	...
	JToolBar createToolBar() {
		...
		next = new JButton(MainWindow.getIcon("next.png"));
		next.addActionListener(this);
		next.setRolloverIcon(MainWindow.getIcon("next_r.png"));
		back = new JButton(MainWindow.getIcon("back.png"));
		back.addActionListener(this);
		back.setRolloverIcon(MainWindow.getIcon("back_r.png"));
		toolbar.add(back);
		toolbar.add(next);
